...
ClapTrap::ClapTrap(): _Name("Yasser"), _hitPoints(10), _energyPoints(10), _attackDamage(0), _maxHp(10)
{
...
ClapTrap::ClapTrap(const ClapTrap &other) :  _Name(other._Name), _hitPoints(other._hitPoints),
	_energyPoints(other._energyPoints), _attackDamage(other._attackDamage), _maxHp(other._maxHp)
{
...
void ClapTrap::beRepaired(unsigned int amount)
{
    ...
    {
        std::cout << "no need to repair, '" << getName() << "' is already at "<< getMaxHp() <<" HP.\n";
        return;
    }
