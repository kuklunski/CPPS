...
void map_validation(t_data *data)
{
	...
	// take a look at the values return by get next line for the file and protect against that
	// do the same with map , what will data->map have is meets end of line? it will still be null right?
